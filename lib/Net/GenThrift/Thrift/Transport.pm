...
package Net::GenThrift::Thrift::Transport;
...
#
package Net::GenThrift::Thrift::TransportFactory;
...
#
# @return Net::GenThrift::Thrift::Transport transport
#
sub getTransport
{
    my $self  = shift;
...
#
package Net::GenThrift::Thrift::ServerTransport;
