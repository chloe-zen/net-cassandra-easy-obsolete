...
package Net::GenThrift::Thrift::BufferedTransport;
...
#
package Net::GenThrift::Thrift::BufferedTransportFactory;
...
#
# @return Net::GenThrift::Thrift::BufferedTransport transport
#
sub getTransport
{
    my $self  = shift;
    ...
    my $buffered = Net::GenThrift::Thrift::BufferedTransport->new($trans);
    return $buffered;
}
